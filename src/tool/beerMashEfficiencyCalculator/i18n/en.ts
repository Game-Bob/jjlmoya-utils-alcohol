...
const title = 'Beer Mash Efficiency Calculator';
const description = 'Calculate mash efficiency percentage, potential sugar extraction, and expected specific gravity for homebrewing and craft brewing recipes.';

const ui: BeerMashEfficiencyCalculatorUI = {
  unitMetric: 'Metric',
  stagePreboil: 'Pre-boil Wort',
  stagePostboil: 'Post-boil Wort',
  unitImperial: 'Imperial',
  labels: {
    grainWeight: 'Total Grain Bill Weight',
    grainType: 'Grain Potential Preset',
    customPotential: 'Custom Grain Potential (SG)',
    wortVolume: 'Pre-boil / Target Wort Volume',
    measuredSg: 'Measured Specific Gravity (SG)',
    unitSystem: 'Unit System',
    sampleTemp: 'Sample Temperature',
    calibTemp: 'Calibration Temp',
    stageLabel: 'Brewing Stage',
    presets: 'Common Grain Potentials',
  },
  units: {
    weightKg: 'kg',
    weightLb: 'lb',
  ...
  results: {
    efficiencyTitle: 'Mash Efficiency',
    efficiencyBadge: 'Calculated Status',
    correctedGravity: 'Temp-Corrected SG',
    measuredGravity: 'Measured Gravity',
    expectedGravity75: '75% Efficiency SG',
    expectedGravity80: '80% Efficiency SG',
    expectedGravity85: '85% Efficiency SG',
    potentialPoints: 'Total Potential Points',
    extractedPoints: 'Extracted Gravity Points',
    wortBrix: 'Estimated Brix',
  },
  statusMessages: {
    excellent: 'Excellent Extraction (82%+)',
    good: 'Good Efficiency (74% - 81%)',
    average: 'Average Efficiency (65% - 73%)',
    poor: 'Low Extraction (< 65%)',
  },
  kettleVisual: {
