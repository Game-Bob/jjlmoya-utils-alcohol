...
const title = 'Mäskeffektivitetsräknare';
const description = 'Beräkna mäskeffektivitet och sockerutvinning.';
...
const ui: BeerMashEfficiencyCalculatorUI = {
  ...
  labels: {
    ...
    grainType: 'Maltpotential',
    customPotential: 'Egen potential',
    wortVolume: 'Vörtvolym',
    measuredSg: 'Uppmätt SG',
  ...
  results: {
    ...
    expectedGravity75: 'SG vid 75%',
    expectedGravity80: 'SG vid 80%',
    expectedGravity85: 'SG vid 85%',
    potentialPoints: 'Potentiella poäng',
    extractedPoints: 'Extraktpoäng',
    wortBrix: 'Uppskattad Brix',
  },
  statusMessages: {
    excellent: 'Utmärkt (82%+)',
    good: 'God (74% - 81%)',
    average: 'Genomsnittlig (65% - 73%)',
    poor: 'Låg (< 65%)',
  },
  kettleVisual: {
