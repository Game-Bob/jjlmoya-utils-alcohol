...
const title = 'Calculadora de Eficiência da Mostura';
const description = 'Calcule a eficiência da mostura e extração de açúcares.';
...
const ui: BeerMashEfficiencyCalculatorUI = {
  ...
  labels: {
    ...
    grainType: 'Potencial do malte',
    customPotential: 'Potencial personalizado',
    wortVolume: 'Volume do mosto',
    measuredSg: 'Gravidade medida',
    unitSystem: 'Sistema de unidades',
    sampleTemp: 'Temperatura amostra',
    calibTemp: 'Temperatura calibração',
    stageLabel: 'Etapa de mostura',
    presets: 'Potenciais comuns',
  },
  units: {
    weightKg: 'kg',
    weightLb: 'lb',
  ...
  results: {
    ...
    potentialPoints: 'Pontos potenciais',
    extractedPoints: 'Pontos extraídos',
    wortBrix: 'Brix estimado',
  },
  statusMessages: {
    excellent: 'Excelente (82%+)',
    good: 'Boa (74% - 81%)',
    average: 'Média (65% - 73%)',
    poor: 'Baixa (< 65%)',
  },
