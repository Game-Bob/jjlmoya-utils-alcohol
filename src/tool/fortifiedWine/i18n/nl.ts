...
const bibliography: FortifiedWineBuilderLocaleContent['bibliography'] = [
  { name: 'Jackisch, P. — Moderne Wijnmakerij (Cornell University Press)', url: 'https://www.cornellpress.cornell.edu/book/9780801493355/modern-winemaking/' },
  { name: 'Goode, J. — De Wetenschap van Wijn (University of California Press)', url: 'https://www.ucpress.edu/book/9780520276895/the-science-of-wine' },
  { name: 'Pearson Vierkant — University of California ANR', url: 'https://ucanr.edu/sites/wineserver/files/24612.pdf' },
];
